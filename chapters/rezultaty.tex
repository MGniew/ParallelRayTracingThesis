...
\begin{tikzpicture}
  \begin{axis}[
    xlabel=liczba pikseli,
    ylabel=$\frac{liczba\ obiektów}{czas}$,
    ...
    \addlegendentry{Spheres}
	\addlegendentry{Glass}
	\addlegendentry{Suzanne}
	\addlegendentry{Room}
  \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addlegendentry{bez cieni}
	\addlegendentry{z cieniami}
  \end{axis}
\end{tikzpicture}
\end{subfigure}
\hfill
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[xscale=0.925, yscale=0.95]
	  \begin{axis}[
	    title=(a),
	    xlabel=liczba fragmentów,
	    ylabel=czas \lbrack s\rbrack,
	    ...
	    \addlegendentry{1 proc.}
	    \addlegendentry{4 proc.}
		\addlegendentry{9 proc.}
		\addlegendentry{14 proc.}
	  \end{axis}
	\end{tikzpicture}
	\end{subfigure}
	\begin{subfigure}[b]{.5\textwidth}
	...
	\end{tikzpicture}
\end{subfigure}
\caption{\emph{Spheres}; (a) - zależność czasu generowania obrazu od liczby fragmentów, (b) - zależność czasu generowania obrazu od liczby procesów}
\end{figure}
...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\end{subfigure}
\caption{\emph{Glass}; (a) - zależność czasu generowania obrazu od liczby fragmentów, (b) - zależność czasu generowania obrazu od liczby procesów}
\end{figure}
\newpage
\begin{figure}[H]
\begin{longtable}{|c|r|r|r|}
		\caption{Glass - zrównoleglenie}\label{gla} \\ \hline
	    \multirow{2}{*}{liczba fragmentów} & \multicolumn{3}{|c|}{spf [s]} \\ \cline{2-4}
	 	& 4 proc. & 9 proc. & 14 proc. \\ \hline
...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\end{subfigure}
\caption{\emph{Suzzane}; (a) - zależność czasu generowania obrazu od liczby fragmentów, (b) - zależność czasu generowania obrazu od liczby procesów}
\end{figure}

\begin{figure}[H]
\begin{longtable}{|c|r|r|r|}
		\caption{Suzzane - zrównoleglenie} \\ \hline
	    \multirow{2}{*}{liczba fragmentów} & \multicolumn{3}{|c|}{spf [s]} \\ \cline{2-4}
	 	& 4 proc. & 9 proc. & 14 proc. \\ \hline
...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\end{subfigure}
\caption{\emph{Room}; (a) - zależność czasu generowania obrazu od liczby fragmentów, (b) - zależność czasu generowania obrazu od liczby procesów}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace*{-6mm}
\begin{figure}[H]
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[xscale=0.925, yscale=0.95]
	  \begin{axis}[
	    ...
	    \addlegendentry{bez bryły ot.}
	    \addlegendentry{z bryłą ot.}
	  \end{axis}
	\end{tikzpicture}
	\end{subfigure}
	\begin{subfigure}{.5\textwidth}
	...
	\end{tikzpicture}
\end{subfigure}
\caption{Wykresy pokazujące zależność czasu generowania klatki od liczby fragmentów dla algorytmu wykorzystującego drzewo BSP; (a) - wykres dla sceny \emph{Glass}, (b) - wykres dla sceny \emph{Suzanne}}
\end{figure}
...
%
%\end{subfigure}
%\caption{\emph{Suzzane} - czas generowania klatki z wykorzystaniem drzewa BSP (czas budowy drzewa - 317.279 s)}
%\end{figure}
